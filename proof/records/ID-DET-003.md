...
This record backfills proof authority for ID-DET-003 from repo-visible source and controlled validation evidence only.
...
ID-DET-003 has source truth in the detections repo. The identity detection package identifies the case as repo-visible source evidence.

## 4. Validation Truth

ID-DET-003 has controlled validation evidence in the validation repo. This record treats that evidence as controlled-test validation only.
...
- hawkinsoperations-detections/detections/identity/id-det-003/event-mapping.yml
- hawkinsoperations-detections/detections/identity/id-det-003/status.yml
- hawkinsoperations-validation/reports/id-det-003/validation-result.json
- hawkinsoperations-validation/reports/id-det-003/validation-result.md
- hawkinsoperations-validation/scripts/validate-id-det-003.py
- hawkinsoperations-validation/scripts/verify-id-det-003-result-parity.py
- hawkinsoperations-platform/scripts/ho_factory.py

## 12. What This Record Proves

- A proof record exists for ID-DET-003.
