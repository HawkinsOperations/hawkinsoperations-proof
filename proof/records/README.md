...
| RUNTIME-ROUTE-PROOF-V1-PRIVATE-CANDIDATE | private runtime route proof candidate | [proof/records/RUNTIME-ROUTE-PROOF-V1-PRIVATE-CANDIDATE.md](RUNTIME-ROUTE-PROOF-V1-PRIVATE-CANDIDATE.md) | [proof/maps/RUNTIME-ROUTE-PROOF-V1-REVIEWER-MAP.md](../maps/RUNTIME-ROUTE-PROOF-V1-REVIEWER-MAP.md) | PRIVATE_RUNTIME_ROUTE_PROOF_V1_CANDIDATE_PRESERVED | NOT_PUBLIC_SAFE | Reviewer-safe summary and hash preservation for one private controlled Wazuh -> Cribl -> Splunk marker route. | Public-safe runtime proof, production SOC operation, autonomous SOC operation, broad ingestion, public publication approval, AI-decided disposition, analyst-approved disposition, Lifetime Governed Case mutation. | Separate public-safe review, evidence-link review, privacy review, wording review, and Raylee approval before any stronger claim ceiling. |
...
- HO-NDR-001: private boundary scaffold route. The validation repo owns the Security Onion visibility contract and cross-source corroboration scaffold. This does not approve runtime execution, public-safe proof, production NDR claims, Security Onion telemetry forwarding, Splunk searches, Cribl route changes, or achieved cross-source corroboration.
