# ID-DET-004 ProofCard

## 1. Card Summary

proofcard_version: proofcard-backfill-v0
case_id: ID-DET-004
proof_record_path: proof/records/ID-DET-004.md
...
This card summarizes the existing ID-DET-004 proof record. It does not raise the proof ceiling.
...
- ProofCard exists for ID-DET-004.
- Proof record exists for ID-DET-004.
