# ID-DET-003 ProofCard

## 1. Card Summary

proofcard_version: proofcard-backfill-v0
case_id: ID-DET-003
proof_record_path: proof/records/ID-DET-003.md
...
This card summarizes the existing ID-DET-003 proof record. It does not raise the proof ceiling.
...
- ProofCard exists for ID-DET-003.
- Proof record exists for ID-DET-003.
