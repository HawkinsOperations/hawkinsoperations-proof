# ID-DET-001 ProofCard

## 1. Card Summary

proofcard_version: proofcard-backfill-v0
case_id: ID-DET-001
proof_record_path: proof/records/ID-DET-001.md
...
This card summarizes the existing ID-DET-001 proof record. It does not raise the proof ceiling.
...
- ProofCard exists for ID-DET-001.
- Proof record exists for ID-DET-001.
