...
| Installation | Persistence, service creation, scheduled task creation, and foothold maintenance behavior. | Mixed: PRIVATE_RUNTIME_EVIDENCE_CAPTURED for HO-DET-011; CONTROLLED_TEST_VALIDATED and NO_PROOF_RECORD for HO-DET-012. | HO-DET-011 proof record; HO-DET-012 validation report and proof index boundary. | public-safe proof, signal-observed, production deployment, complete service-creation coverage, scheduled-task coverage completeness. |
| Command & Control | NDR visibility, cross-source corroboration shape, and pipeline route integrity support. | BOUNDARY_CONTRACT_ONLY / SOURCE_EXISTS / VALIDATION_PLANNED. | HO-NDR-001 boundary contract and card; HO-PIPE-001 source contract. | Security Onion observed proof, Cribl-routed proof, Wazuh-routed proof, live Splunk, signal-observed. |
...
- Current proof state: ID-DET-001..004 are NO_PROOF_RECORD in the proof index; HO-NDR-001 is BOUNDARY_CONTRACT_ONLY; HO-PIPE-001 is SOURCE_EXISTS / VALIDATION_PLANNED in source truth.
- Validation state: ID-DET-001..004 are CONTROLLED_TEST_VALIDATED in validation reports with 10 controlled identity fixtures each, 5 positive, 5 negative, 0 missed positives, and 0 false-positive negatives. HO-NDR-001 has validation contract enforcement for contract shape. HO-PIPE-001 validation remains planned.
- What exists: Source packages for ID-DET-001..004 and HO-PIPE-001, validation reports for ID-DET-001..004, the HO-NDR-001 boundary contract and proof card, and proof-index no-proof-record boundaries for the identity family.
...
- HawkinsOperations artifacts: detection source packages, Splunk/Sigma/Wazuh source where present, validation packages, validation registry, parity verifiers, claim-boundary scanners, proof status index, proof records for HO-DET-001, HO-DET-011, and AWS-DET-001.
...
- Current proof state: proof records exist only where the proof repo records them. HO-DET-012 and ID-DET-001..004 remain NO_PROOF_RECORD. HO-DET-013 remains SOURCE_EXISTS / VALIDATION_PLANNED. HO-NDR-001 remains a boundary scaffold route.
- Validation state: controlled validation exists for HO-DET-001, HO-DET-011, HO-DET-012, AWS-DET-001, and ID-DET-001..004. Validation is planned for HO-DET-013 and HO-PIPE-001.
...
- Current proof state: HO-DET-011 is PRIVATE_RUNTIME_EVIDENCE_CAPTURED and NOT_PUBLIC_SAFE in the proof record. HO-DET-012 is NO_PROOF_RECORD in the proof index with runtime, signal, and public-safe proof not proven.
...
- What exists: Source packages for both detections, validation reports, claim-boundary scanners, HO-DET-011 proof record, HO-DET-012 no-proof-record proof index boundary, and platform case-packet visibility for HO-DET-011 with drift review noted in platform contract docs.
...
- Automation support: validator scripts, result parity checks, claim-boundary scanners, proof status index, proof record route for HO-DET-011, and case-packet guardrails.
...
- Next promotion gate: public-safe evidence review for HO-DET-011; proof record creation under separate scope for HO-DET-012; route correlation review; stale review; wording review; human approval.
...
- Current proof state: HO-NDR-001 is BOUNDARY_CONTRACT_ONLY with proof card and boundary contract routes. HO-PIPE-001 is SOURCE_EXISTS / VALIDATION_PLANNED and not a runtime route proof.
- Validation state: HO-NDR-001 contract/verifier shape is enforced in validation. HO-PIPE-001 validation remains planned.
- What exists: Security Onion visibility contract, cross-source corroboration sample, verifier routes, proof card, boundary doc, and source-controlled pipeline route integrity contract.
- What it proves: Boundary and contract shapes exist for future NDR/cross-source review. Pipeline source artifacts exist for future route integrity validation.
