...
| 8. Public proof boundary | PROVEN | `CONTROLLED_TEST_VALIDATED`. | Public proof remains controlled-test-only. | Production, autonomous SOC, Cribl-routed, or Wazuh-routed proof. |
